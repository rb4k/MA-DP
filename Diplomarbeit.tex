...
\begin{table}[h!]
  ...
  \begin{flushleft}
    \begin{tabular}{lp{11.5cm}}  %hier die Spaltenausrichtung und Anzahl eintragen
    $\textbf{a}_{j}$ & Vektor des Ressourcenverbrauchs bzw. der Bestandsveränderung der Produktanfrage $j$\\
    $a_{hj}$ &	Verbrauch bzw. Bestandsveränderung der Ressource $h$ der Produkt\-anfrage $j$\\
